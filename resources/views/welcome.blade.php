...
<body>
    ...
    <div class="body-inner">
        ...
        <header id="header" data-transparent="true" data-fullwidth="true" class="dark submenu-light">
            <div class="header-inner">
                <div class="container">
                    ...
                    <div id="logo">
                        <a href="index.html">
                            <span class="logo-default">CKSTJV-DC</span>
                            <span class="logo-dark">CKSTJV-DC</span>
                        </a>
                    </div>
                    <!--End: Logo-->
                    <!-- Search -->
        ...
        <div id="slider" class="inspiro-slider slider-fullscreen dots-creative" data-fade="true">
            <!-- Slide 1 -->
            <div class="slide kenburns" data-bg-image="{{ asset('assets/images/slider/charles.jpg') }}">
                <div class="bg-overlay"></div>
                <div class="container">
                    <div class="slide-captions text-center text-light">
                        <!-- Captions -->
                        <h1 data-caption-animate="zoom-out">WELCOME TO "CDCS-DC"</h1>
...
It allows organizations track correspondence from a variety of resources including scanned letters, e-mails, faxes, and electronic documents, and manages them through automated processes to ensure proper handling of requests in a timely response. It provides a secure and safe document storage that secures access and prevents documents loss.</p>
            ...
            <!-- end: Slide 1 -->
            <!-- Slide 2 -->
            <div class="slide" data-bg-video="{{ asset('assets/video/train1.mov') }}">
                <div class="bg-overlay"></div>
                <div class="container">
                    <div class="slide-captions text-start text-light">
                        ...
                        <p class="text-medium">- สัญญาที่ 2 ช่วงงาว-เชียงราย</p>
                        <p class="text-medium">- สัญญาที่ 3 เชียงราย-เชียงของ</p>
                        <div><a href="#welcome" class="btn btn-primary scroll-to">Explore more</a></div>
                        <!-- end: Captions -->
                    </div>
                </div>
